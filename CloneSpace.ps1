...
. ([IO.Path]::Combine('src', 'Cloners', 'ActionCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'EnvironmentCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'ExternalFeedCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'LibraryVariableSetCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'LifecycleCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'LogoCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'MachinePolicyCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'PackageCloner.ps1'))
...
. ([IO.Path]::Combine('src', 'Cloners', 'ScriptModuleCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'StepTemplateCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'TargetCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'TeamCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'TeamUserRoleCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'TenantCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'TenantTagSetCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'VariableSetValuesCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'WorkerCloner.ps1'))
. ([IO.Path]::Combine('src', 'Cloners', 'WorkerPoolCloner.ps1'))
